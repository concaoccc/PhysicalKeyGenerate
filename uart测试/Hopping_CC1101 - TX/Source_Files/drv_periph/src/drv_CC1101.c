...
/**
  ...
  */
uint8_t CC1101_Rx_Packet( uint8_t *RxBuff,int *RSSI )
{
	uint8_t l_PktLen = 0;
...
void CC1101_Init( void )
{
	...
	CC1101_Set_Address( 0x03, BROAD_0AND255 );	//设备地址 和 地址检测模式设置
...
void ToAscii(int r,uint8_t *ascii)
{
	ascii[0]='';
	ascii[1]='';
	ascii[2]='';
